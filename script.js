...
function renderComparisonBody(element, body, diameterKm, maxDiameterKm, maxVisualSize) {
  ...
  element.style.setProperty("--compare-color", body.color || "#8dd8ff");
  element.style.setProperty("--compare-glow", body.glow || "rgba(141, 216, 255, 0.35)");
  element.classList.toggle("is-ringed", !!body.hasRings);
}
